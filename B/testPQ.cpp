...
int main() {
    vector<int> v {9, 2, 4, 5, 15, 3}; 
    PairingPQ<int> *b = new PairingPQ<int>(v.begin(), v.end());
    //PairingPQ<int> b(v.begin(), v.end());
    //PairingPQ<int *, IntPtrComp> * b = new PairingPQ<int *, IntPtrComp>;
    // b.pop(); 
    // cout << b.top() << '\n';
    // b.pop(); 
    // b.pop(); 
    ...
    // b.push(20);
    // const int x = 7; 
    // PairingPQ<int>::Node * n = b.addNode(x); 
    // b.updateElt(n, 50);
    // cout << b.top() << '\n';
    delete b;
}
